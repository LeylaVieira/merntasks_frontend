...
const ModalFormularioTarea = () => {
    ...
    // Para cargar los datos de la tarea cuando hacemos click en Editar
    useEffect(() => {
        if(tarea?._id) {
            setId(tarea._id)
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        ...
                                        <input
                                            type='submit'
                                            className='bg-sky-600 hover:bg-sky-900 w-full p-3 text-white uppercase font-bold cursor-pointer transition-colors rounded text-sm'
